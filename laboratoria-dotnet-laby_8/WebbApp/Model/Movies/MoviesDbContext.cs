...
using WebbApp.Models.Movies;

namespace WebbApp.Model.Movies;
...
public partial class MoviesDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Movie>(entity =>
        {
            ...
            // Ustaw klucz główny i automatyczne generowanie wartości
            entity.HasKey(e => e.MovieId);
            entity.Property(e => e.MovieId)
                .ValueGeneratedOnAdd() // Automatyczne generowanie ID
                .HasColumnType("INTEGER") // W SQLite typ `INTEGER` jest wymagany dla AUTOINCREMENT
